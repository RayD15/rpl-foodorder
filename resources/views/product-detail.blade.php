...
@section('content')
    <nav class="animate-rise mb-4">
        <a href="{{ route('menu') }}" class="inline-flex items-center gap-1 text-sm font-semibold text-ink-500 hover:text-tomato-600">
    ...
    <div class="animate-rise overflow-hidden rounded-3xl border-2 border-ink-200 bg-cream-100 card-brutal-hover" style="--reveal-delay:60ms">
        ...
        <div class="p-6">
            ...
            <p class="mt-1 text-2xl font-extrabold text-tomato-600">{{ 'Rp' . number_format($product->price, 0, ',', '.') }}</p>
