...
@section('content')
    ...
    <div id="cart-empty" class="hidden">
        <div class="reveal py-16 text-center">
            ...
            <a href="{{ route('menu') }}" class="inline-flex items-center gap-2 rounded-xl border-2 border-ink-900 bg-tomato-500 px-6 py-3 text-sm font-extrabold text-white shadow-[4px_4px_0_0_var(--color-ink-900)] transition hover:bg-tomato-600 active:translate-x-0.5 active:translate-y-0.5 active:shadow-none">Lihat Menu</a>
        </div>
    </div>

    <div id="cart-items" class="flex flex-col gap-4"></div>

    <div id="cart-summary-section" class="reveal mt-6 rounded-3xl border-2 border-ink-200 bg-cream-100 p-5 card-brutal-hover">
        ...
        <div class="mt-2 flex justify-between border-t border-dashed border-ink-300 pt-3 text-base font-extrabold text-ink-900">
            <span>Total</span><span id="cart-grand-total" class="text-tomato-600"></span>
        </div>
        <a href="{{ route('checkout') }}" id="cart-checkout-btn"
            class="mt-4 flex items-center justify-center gap-2 rounded-2xl border-2 border-ink-900 bg-tomato-500 px-6 py-4 text-base font-extrabold text-white shadow-[5px_5px_0_0_var(--color-ink-900)] transition hover:bg-tomato-600 hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-[3px_3px_0_0_var(--color-ink-900)] active:translate-x-1 active:translate-y-1 active:shadow-none">
            Lanjut Checkout
