...
@section('content')
    <div class="mb-6 flex items-center justify-between">
        ...
        <a href="{{ route('admin.products.create') }}" class="inline-flex items-center gap-1.5 rounded-xl border-2 border-ink-900 bg-tomato-500 px-4 py-2.5 text-sm font-extrabold text-white shadow-[3px_3px_0_0_var(--color-ink-900)] transition hover:bg-tomato-600 active:translate-x-0.5 active:translate-y-0.5 active:shadow-none">
    ...
    @forelse ($products as $product)
        ...
        <div class="mb-3 rounded-2xl border-2 border-ink-200 bg-cream-100 p-4 card-brutal-hover md:hidden">
            ...
            <div class="mt-3 flex gap-2">
                <a href="{{ route('admin.products.edit', $product) }}" class="flex-1 rounded-xl border-2 border-ink-900 bg-cream-50 px-3 py-2 text-center text-sm font-bold text-ink-700 transition hover:bg-cream-200">Edit</a>
