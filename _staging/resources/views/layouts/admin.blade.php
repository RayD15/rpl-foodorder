        ...
        <aside class="hidden w-64 flex-shrink-0 flex-col border-r border-ink-200 bg-cream-100 p-5 md:flex">
            ...
            <nav class="flex flex-1 flex-col gap-1">
                <a href="{{ route('admin.dashboard') }}"
                    class="rounded-xl px-4 py-2.5 text-sm font-semibold {{ request()->routeIs('admin.dashboard') ? 'bg-clip-text text-transparent bg-gradient-to-r from-honey-400 via-leaf-400 to-leaf-500 shadow-xs' : 'bg-clip-text text-transparent bg-gradient-to-r from-honey-400 via-leaf-400 to-leaf-500 hover:bg-cream-200/50' }}">
                ...
                <a href="{{ route('admin.products.index') }}"
                    class="rounded-xl px-4 py-2.5 text-sm font-semibold {{ request()->routeIs('admin.products.*') ? 'bg-clip-text text-transparent bg-gradient-to-r from-honey-400 via-leaf-400 to-leaf-500 shadow-xs' : 'bg-clip-text text-transparent bg-gradient-to-r from-honey-400 via-leaf-400 to-leaf-500 hover:bg-cream-200/50' }}">
                ...
                <a href="{{ route('admin.categories.index') }}"
                    class="rounded-xl px-4 py-2.5 text-sm font-semibold {{ request()->routeIs('admin.categories.*') ? 'bg-clip-text text-transparent bg-gradient-to-r from-honey-400 via-leaf-400 to-leaf-500 shadow-xs' : 'bg-clip-text text-transparent bg-gradient-to-r from-honey-400 via-leaf-400 to-leaf-500 hover:bg-cream-200/50' }}">
                ...
                <a href="{{ route('admin.bundles.index') }}"
                    class="rounded-xl px-4 py-2.5 text-sm font-semibold {{ request()->routeIs('admin.bundles.*') ? 'bg-clip-text text-transparent bg-gradient-to-r from-honey-400 via-leaf-400 to-leaf-500 shadow-xs' : 'bg-clip-text text-transparent bg-gradient-to-r from-honey-400 via-leaf-400 to-leaf-500 hover:bg-cream-200/50' }}">
                ...
                <a href="{{ route('admin.settings.edit') }}"
                    class="rounded-xl px-4 py-2.5 text-sm font-semibold {{ request()->routeIs('admin.settings.*') ? 'bg-clip-text text-transparent bg-gradient-to-r from-honey-400 via-leaf-400 to-leaf-500 shadow-xs' : 'bg-clip-text text-transparent bg-gradient-to-r from-honey-400 via-leaf-400 to-leaf-500 hover:bg-cream-200/50' }}">
        ...
        <div class="flex min-w-0 flex-1 flex-col">
            <header class="sticky top-0 z-20 border-b border-ink-100 bg-white/90 backdrop-blur md:hidden">
                ...
                <nav class="grid grid-cols-5 gap-1 px-3 pb-3">
                    <a href="{{ route('admin.dashboard') }}" class="flex flex-col items-center gap-0.5 rounded-xl px-1 py-2 transition {{ request()->routeIs('admin.dashboard') ? 'bg-clip-text text-transparent bg-gradient-to-r from-honey-400 via-leaf-400 to-leaf-500' : 'bg-clip-text text-transparent bg-gradient-to-r from-honey-400 via-leaf-400 to-leaf-500 hover:bg-cream-200/50' }}">
                    ...
                    <a href="{{ route('admin.products.index') }}" class="flex flex-col items-center gap-0.5 rounded-xl px-1 py-2 transition {{ request()->routeIs('admin.products.*') ? 'bg-clip-text text-transparent bg-gradient-to-r from-honey-400 via-leaf-400 to-leaf-500' : 'bg-clip-text text-transparent bg-gradient-to-r from-honey-400 via-leaf-400 to-leaf-500 hover:bg-cream-200/50' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" class="h-4 w-4"><path stroke-linecap="round" stroke-linejoin="round" d="M15.182 15.182a4.5 4.5 0 01-6.364 0M21 12a9 9 0 11-18 0 9 9 0 0118 0zM9.75 9.75c0 .414-.168.75-.375.75S9 10.164 9 9.75 9.168 9 9.375 9s.375.336.375.75Zm-.375 0h.008v.015h-.008V9.75zm5.625 0c0 .414-.168.75-.375.75s-.375-.336-.375-.75.168-.75.375-.75.375.336.375.75Zm-.375 0h.008v.015h-.008V9.75z" /></svg>
                        <span class="text-[9px] font-medium leading-tight">Produk</span>
                    </a>
                    <a href="{{ route('admin.categories.index') }}" class="flex flex-col items-center gap-0.5 rounded-xl px-1 py-2 transition {{ request()->routeIs('admin.categories.*') ? 'bg-clip-text text-transparent bg-gradient-to-r from-honey-400 via-leaf-400 to-leaf-500' : 'bg-clip-text text-transparent bg-gradient-to-r from-honey-400 via-leaf-400 to-leaf-500 hover:bg-cream-200/50' }}">
                    ...
                    <a href="{{ route('admin.bundles.index') }}" class="flex flex-col items-center gap-0.5 rounded-xl px-1 py-2 transition {{ request()->routeIs('admin.bundles.*') ? 'bg-clip-text text-transparent bg-gradient-to-r from-honey-400 via-leaf-400 to-leaf-500' : 'bg-clip-text text-transparent bg-gradient-to-r from-honey-400 via-leaf-400 to-leaf-500 hover:bg-cream-200/50' }}">
                    ...
                    <a href="{{ route('admin.settings.edit') }}" class="flex flex-col items-center gap-0.5 rounded-xl px-1 py-2 transition {{ request()->routeIs('admin.settings.*') ? 'bg-clip-text text-transparent bg-gradient-to-r from-honey-400 via-leaf-400 to-leaf-500' : 'bg-clip-text text-transparent bg-gradient-to-r from-honey-400 via-leaf-400 to-leaf-500 hover:bg-cream-200/50' }}">
